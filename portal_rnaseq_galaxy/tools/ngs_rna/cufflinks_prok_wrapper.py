...
def __main__():
    ...
    parser.add_option( '--overlap_radius', dest='overlap_radius', help='Transfrags that are separated by less than this distance get merged together, and the gap is filled. Default: 50 (in bp).' )
    ...
    if options.overlap_radius:
        cmd += ( " --overlap-radius %i" % int ( options.overlap_radius ) )
