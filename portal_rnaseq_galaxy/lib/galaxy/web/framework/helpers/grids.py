...
class Grid( object ):
    ...
    def grid_pass_template(self, trans, grid_template, **kwargs):
        """Allow the grid to pass paremeters for filling template to derived child class instead of rendering directly"""
        return trans.fill_template(grid_template, **kwargs)       
    def __call__( self, trans, **kwargs ):
        ...
        # as str.
        return self.grid_pass_template(trans, iff( async_request, self.async_template, self.template ),
                                    grid=self,
                                    query=query,
