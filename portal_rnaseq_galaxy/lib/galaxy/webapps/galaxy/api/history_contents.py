...
class HistoryContentsController( BaseAPIController, UsesHistoryDatasetAssociationMixin, UsesHistoryMixin,
    ...
    @web.expose_api
    def index( self, trans, history_id, ids=None, deleted='False', **kwd ):
        """
        ...
        """
        rval = []
        show_deleted=(deleted=='True' or deleted=='true' or deleted==True)
        try:
            ...
            if ids:
                ...
                for hda in history.datasets:
                    ...
                    if encoded_hda_id in ids and (not hda.deleted or show_deleted):
                ...
                for hda in history.datasets:
                    if not hda.deleted or show_deleted:
