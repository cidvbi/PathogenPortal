...
<html>
    ...
    <body scroll="no" class="full-content ${self.body_class}">
        ...
        <div id="everything" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; min-width: 600px;">
            ...
            <div id="pathport_banner">
        <div id="top_brc_links">
	    <div id="rocket_image_text" style="float:left; margin-top:20px; margin-right:10px;">
	    <font color="#6F7178" size="18"><i>RNA-Rocket</i></font>
	    </div>
            <span id="rocket_image_area">
                <object data="/static/images/rocket3-horizontal_v2.svg" style="height:62px;width:180px" type="image/svg+xml"></object>
            </span>
            <span style="float:right; margin-right:25px">
                %if trans.user:
                    ${trans.user.email} | <a href="${h.url_for( controller='/user', action='logout')}">Logout</a>
                %else:
                    <a href="${h.url_for( controller='/user', action='login' )}" target="galaxy_main">Login</a> 
                    | 
                    <a href="${h.url_for( controller='/user', action='create' )}" target="galaxy_main">Create an Account</a>
                %endif
            </span>
            <span id="critter_image_area" style="float:right; margin-top:10px;">
                <img src="/static/images/critters.png" alt="Image map with pictures of organisms representing five Bioinformatics Resource Centers" usemap="#crittermap">
	    </span>
            <map name="crittermap">
                <area shape="rect" coords="0,0,113,60" href="http://eupathdb.org" alt="visit EuPathDB" title="Visit EuPathDB">
                <area shape="rect" coords="115,0,210,60" href="http://fludb.org" alt="visit IRD" title="Visit IRD">
                <area shape="rect" coords="212,0,306,60" href="http://patricbrc.org" alt="visit PATRIC" title="Visit PATRIC">
                <area shape="rect" coords="308,0,411,60" href="http://vectorbase.org" alt="visit VectorBase" title="Visit VectorBase">
                <area shape="rect" coords="413,0,510,60" href="http://viprbrc.org" alt="visit ViPR" title="Visit ViPR">
             </map>
